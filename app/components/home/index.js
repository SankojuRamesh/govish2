  ...
  return (
    <>
      <Container style={{ marginTop: "100px" }}>
        ...
        <Grid container spacing={3} className="mt-5 gup">
          <Grid size={{ xs: 12 }}>
            <h5 className="mb-0">How it Works Video Edior</h5>
            <p className="mb-0 text-black text-opacity-50">
        ...
        <Grid container spacing={3} className="mt-5">
          <Grid size={{ xs: 12 }}>
            <h2 className="mb-0 primary-color">Video Edior Helights</h2>
            <p className="mb-0 text-black text-opacity-50">
              Save thousands to millions of bucks by using single tool for
              different amazing and great useful admin
            </p>
        ...
        <Grid container spacing={3} className="mt-5">
          <Grid size={{ xs: 12 }}>
            <h2 className="mb-0 primary-color">Our Clients</h2>
            <p className="mb-0 text-black text-opacity-50">
              Save thousands to millions of bucks by using single tool for
              different amazing and great useful admin
            </p>
        ...
        <Grid container spacing={3} className="mt-5">
          <Grid size={{ xs: 12 }}>
            <h2 className="mb-0 primary-color">What Our Clients Say</h2>
            <p className="mb-0 text-black text-opacity-50">
              Save thousands to millions of bucks by using single tool for
              different amazing and great useful admin
            </p>
